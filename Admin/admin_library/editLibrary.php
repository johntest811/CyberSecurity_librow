...
<form action="" name=form1 method="post" enctype="multipart/form-data">
  <div class="container">
   ...
   <br><br>
    ...
    <input type="text" placeholder="Please Enter title" id="psw" name="title" value="<?php echo $title; ?>">

    <label for="psw-repeat">Author</label>
    <input type="text" placeholder="Please Enter author" id="psw-repeat" name="author" value="<?php echo $author; ?>">
    
 
    <label for="psw-repeat"><b>Book Stocks</b></label>
    <input type="text" placeholder="Enter Quantity" id="psw-repeat" name="bookstock" value="<?php echo $bookstock; ?>">
...
if(isset($_POST["update"]))
{
    ...
    if($fnm=="")
    {
        mysqli_query($link,"update books set title='$_POST[title]',author='$_POST[author]',bookstock='$_POST[bookstock]' where id=$id");
    }
    else
    {
        $dst="./images/".$tm.$fnm;
        ...
        mysqli_query($link,"update books set title='$_POST[title]',author='$_POST[author]',bookstock='$_POST[bookstock]',image='$dst1' where id=$id");
    }
